      ...
      <Query>
        ...
        <main>
          <section className="second">
            <section>
              ...
              <p>
                ...
                change-makers including the academe, local and national
                government agencies, NGOs,industry association and chambers of
                ecommerce. By fostering cross sector collaboration, we ensure
                that circular economy strategies are informed, inclusive, and
          ...
          <section className="third">
            <article>
              ...
              <p>
                ...
                <span> continuous cycle of dialogue, knowledge sharing </span>{" "}
                and
          ...
          <section className="fourth">
            ...
            <article>
              <p>
                In the Philippines we focus on five interconnected plans that
                are critical to advancing a circular economy and building
                climates residence
              </p>
            </article>
            <CarouselComponent
